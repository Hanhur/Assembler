...
ClassRoom_VirtualAlloc		proto
ClassRoom_VirtualFree		proto
;-------------------------------------------
ClassRoom_LoadBackground	proto :DWORD, :DWORD
;-------------------------------------------
...
.code 
ClassRoom_VirtualFree proc uses ebx esi edi
	fn VirtualFree, lpvBase, 0, MEM_RELEASE
	Ret
ClassRoom_VirtualFree endp
;======================================================
ClassRoom_VirtualAlloc proc uses ebx esi edi
	...
	;------------------------------
	@@:
		mov dword ptr[eax], offset ClassRoom_onRender
		mov dword ptr[eax + 4], offset ClassRoom_onLoop
		mov dword ptr[eax + 8], offset ClassRoom_onEvent
		mov dword ptr[eax + 12], offset ClassRoom_onQuit
		mov dword ptr[eax + 16], offset ClassRoom_onKeyDown
	Ret
ClassRoom_VirtualAlloc endp
;======================================================
ClassRoom_CreateRoom proc uses ebx esi edi idRoom:DWORD
	switch idRoom
		...
		case STATE_ROOM_FIRST
			fn ClassEntity_Create, ASTEROID, 183, 10, 50, 50, 272, 32
			fn ClassEntity_Create, ASTEROID, 183, 10, 50, 50, 16, 96
			;---------------------------------------------------
			fn ClassEntity_Create, MOON, 8, 0, 64, 64, 496, 64
			fn ClassEntity_Create, MOON, 8, 0, 64, 64, 80, 72
			;---------------------------------------------------
			mov eax, lpvBase
			mov dword ptr[eax + 4], offset ClassGameRoom_onLoop
...
;=====================================================================
ClassGameRoom_onLoop proc uses ebx esi edi
	fn ClassRoom_onLoop
	;--------------------------------------
...
;=====================================================================
ClassRoom_LoadBackground proc uses ebx esi edi hInst:DWORD, idBmp:DWORD
