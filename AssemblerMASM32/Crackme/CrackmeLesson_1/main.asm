...
WinMain proc hInst:DWORD, hPrev:DWORD, CommandLine:DWORD, show:DWORD
     ...
     fn CreateWindowEx, 0, atom, CADD("GUI Window Demo."), WS_OVERLAPPED or WS_MINIMIZEBOX or WS_MAXIMIZEBOX or WS_SYSMENU or WS_THICKFRAME or WS_CAPTION, CW_USEDEFAULT, CW_USEDEFAULT, WINDOW_W, WINDOW_H, 0, 0, hInst, 0
     ;---------------------                           
     push eax
     pop hWnd
     ;---------------------
